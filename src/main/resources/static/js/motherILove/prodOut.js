...
var RCDOperation = (function ($) {
    ...
    return {
        ...
        query: function () {
            var url = "/prodOut/pagination";
            $.get(url, function (result) {
                queryApp.prodOuts = result.data;
...
var queryApp = new Vue({
    ...
    methods: {
        query: function () {
            ...
            var _self = this;
            $.get(url, function (result) {
                _self.prodOuts = result.data.list;
        ...
        deleteById: function (id) {
            layer.confirm("确认要删除吗，删除后不能恢复", {title: "删除确认"}, function (index) {
                layer.close(index);
                $.get("/prodOut/delete", {id: id}, function (data) {
                    layer.alert(data, {
                            title: "删除操作",
                            btn: ['确定']
                        },
        ...
        openUpdateDialog: function (data) {
            ...
            updateApp.prodName = data.prodName; // 产品
            updateApp.num = data.num;//交货数量
            updateApp.prods = RCDOperation.getProds();
            updateApp.endTime = RCDOperation.getDate();//交货时间
        ...
        openDetailDialog: function (date) {
            ...
            updateApp.comeCount = data.comeCount;  // 信用代码
